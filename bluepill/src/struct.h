...
#define STRUCT_TYPE_TO_NATIVE_LU24 uint32_t
#define STRUCT_TYPE_TO_NATIVE_BU24 uint32_t
#define STRUCT_TYPE_TO_NATIVE_LS24 int32_t
#define STRUCT_TYPE_TO_NATIVE_BS24 int32_t
...
#define STRUCT_TYPE_TO_NATIVE_UPPER_LU24 UNS24
#define STRUCT_TYPE_TO_NATIVE_UPPER_BU24 UNS24
#define STRUCT_TYPE_TO_NATIVE_UPPER_LS24 S24
#define STRUCT_TYPE_TO_NATIVE_UPPER_BS24 S24
...
_TYPEDEF_TYPE(STRUCT_NATIVE(U24))
_TYPEDEF_TYPE(STRUCT_EVITAN(U24))
_TYPEDEF_TYPE(STRUCT_NATIVE(S24))
_TYPEDEF_TYPE(STRUCT_EVITAN(S24))
...
STRUCT_FROM_NATIVE(U, 24)
{
    return 0xFFFFFF & (*((uint32_t *)&x));
}
STRUCT_TO_NATIVE(U, 24)
{
    STRUCT_NATIVE(U24) *a = (STRUCT_NATIVE(U24) *)&x;
    return *a;
}

STRUCT_FROM_NATIVE(S, 24)
{
    return 0xFFFFFF & (*((int32_t *)&x));
}
STRUCT_TO_NATIVE(S, 24)
{
    STRUCT_NATIVE(S24) *a = (STRUCT_NATIVE(S24) *)&x;
    return *a;
}
...
STRUCT_FROM_EVITAN(U, 24)
{
    uint32_t a = *((uint32_t *)&x);
    a = (_BYTE_MASK(a >> 0) << 16) | (_BYTE_MASK(a >> 8) << 8) | (_BYTE_MASK(a >> 16) << 0);
    return a;
}
STRUCT_TO_EVITAN(U, 24)
{
    STRUCT_EVITAN(U24) * a;
    x = (_BYTE_MASK(x >> 0) << 16) | (_BYTE_MASK(x >> 8) << 8) | (_BYTE_MASK(x >> 16) << 0);
    a = (STRUCT_EVITAN(U24) *)&x;
    return *a;
}

STRUCT_FROM_EVITAN(S, 24)
{
    int32_t a = *((int32_t *)&x);
    a = (_BYTE_MASK(a >> 0) << 16) | (_BYTE_MASK(a >> 8) << 8) | (_BYTE_MASK(a >> 16) << 0);
    return a;
}
STRUCT_TO_EVITAN(S, 24)
{
    STRUCT_EVITAN(S24) * a;
    x = (_BYTE_MASK(x >> 0) << 16) | (_BYTE_MASK(x >> 8) << 8) | (_BYTE_MASK(x >> 16) << 0);
    a = (STRUCT_EVITAN(S24) *)&x;
    return *a;
}
